...
<head>
    ...
    <title><?php echo $row->page_name; ?> | Monitoring</title>
    ...
    <div id="wrapper" style="width:160%;">
        ...
        <div>
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Movie Room Monitoring</h1>
                </div>
                <!--End Page Header -->
            </div>
	...
	$(document).ready(function(){
		...
		$(document).on("click","#additional-person",function(){
		  ...
		  if(current_person!=0){//ADDITIONAL PERSON
			...
			$.post("<?php echo $this->config->base_url().'dashboard/get_rooms_movies2';?>",{check_in:check_in, room_id:room_id},function(result){
				...
				<form id="movie_room_form2" method="post" action="<?php echo $this->config->base_url().'dashboard/movie_room_check_in2';?>/'+mrt_id+'">\
				<div class="row">\
					<div class="col-lg-6">\
						<div class="form-group">\
							<label>Room :</label>\
		...
		$(document).on("click",".movie-room-check-in",function(){
			...
			$.get("<?php echo $this->config->base_url().'dashboard/get_rooms_movies';?>/"+room_id,function(result){
				...
				<div class="row">\
					<div class="col-lg-1">\
						<button type="button" class="money-button2 btn btn-default" amount="1">1</button>\
					</div>\
					<div class="col-lg-1">\
						<button type="button" class="money-button2 btn btn-default" amount="5">5</button>\
					</div>\
					<div class="col-lg-1">\
						<button type="button" class="money-button2 btn btn-default" amount="10">10</button>\
					</div>\
					<div class="col-lg-1">\
						<button type="button" class="money-button2 btn btn-default" amount="20">20</button>\
					</div>\
					<div class="col-lg-1">\
						<button type="button" class="money-button2 btn btn-default" amount="50">50</button>\
					</div>\
					<div class="col-lg-1">\
						<button type="button" class="money-button2 btn btn-default" amount="100">100</button>\
					</div>\
					<div class="col-lg-6">\
						<div class="form-group">\
							<label>Change :</label>\
				...
				<div class="row">\
					<div class="col-lg-1">\
						<button type="button" class="money-button2 btn btn-default" amount="200">200</button>\
					</div>\
					<div class="col-lg-1">\
						<button type="button" class="money-button2 btn btn-default" amount="500">500</button>\
					</div>\
					<div class="col-lg-2">\
						<button type="button" class="money-button2 btn btn-default" amount="1000">1000</button>\
					</div>\
					<div class="col-lg-2">\
